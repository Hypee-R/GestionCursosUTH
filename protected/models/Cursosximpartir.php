...
/**
 * This is the model class for table "cursosximpartir".
 *
 * The followings are the available columns in table 'cursosximpartir':
 ...
 */
class Cursosximpartir extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ID_CURSO, CUPO','TOTAL_INSCRITOS', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return Cursosximpartir the static model class
	 */
