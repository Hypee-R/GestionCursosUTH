...
/**
 * This is the model class for table "v_organizados".
 *
 * The followings are the available columns in table 'v_organizados':
 ...
 */
class VOrganizados extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('INSTRUCTOR', 'length', 'max'=>77),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID_CURSO, CURSO, CEDE, FECHA_INICIO, FECHA_FIN, LUGAR, UBICACION, CUPO, STATUS, CATEGORIA, USUARIO, TOTAL_INSCRITOS, INSTRUCTOR', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VOrganizados the static model class
	 */
