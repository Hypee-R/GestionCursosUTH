...
/**
 * This is the model class for table "v_tomados".
 *
 * The followings are the available columns in table 'v_tomados':
 ...
 */
class VTomados extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ID_CURSO, CURSO, CEDE, FECHA_INICIO, FECHA_FIN, LUGAR, UBICACION, STATUS, CATEGORIA, USUARIO', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VTomados the static model class
	 */
