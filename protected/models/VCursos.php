...
/**
 * This is the model class for table "v_cursos".
 *
 * The followings are the available columns in table 'v_cursos':
 ...
 */
class VCursos extends CActiveRecord
{
	/**
	 ...
	 * @return VCursos the static model class
	 */
